...
## Documents Drafted
- IXK Operating Agreement v1.0 (reviewed, ready to sign)
...
- All Kleos/Kleos Design IP (business model, methodology, client deliverables, KIN architecture)
- All speaking/media materials and narrative frameworks

## Pending Legal Actions
- Deposit remaining $475 into Mercury within 30 days
- Calamityville: provisional patent filing ($1,500–$3,000, needs IP attorney)
- Calamityville: trademark clearance search for "Calamityville"
- Consider Kansas state trademark for Calamityville ($40) and Kleos Design ($40)

## Key Legal Notes
- Kansas does not require d/b/a registration. Trade names can be used freely. State trademark ($40/name) or federal trademark ($250-350/class) recommended for name protection.
- Cross-project liability: all brands under one LLC means liability from one can reach others. Spin out into separate entity when a project takes outside equity or reaches significant revenue.
- C-Corp conversion: may be needed if Calamityville pursues VC funding. Requires legal + tax counsel.
