...
## Allegiance Armory
- **Owner:** Cale Swarnes
- **Vertical:** Firearms/Tactical
- **Tier:** Community | **Price:** $500 (received)
- **Status:** ✅ LIVE on Railway, in client review
- **KIN:** blog.json (5 articles, tagged tactical), three-tier feed operational
- **Waiting on Cale:** Facebook group URL, Instagram, photo, domain transfer
- **Repo:** github.com/MathrusseB/AllegianceArmory (private)
...
- **Status:** ✅ V2 LIVE on Railway, 28 visual fixes applied (logo, typography, backgrounds, scroll interactions), video hero integration queued (Cloudflare R2)
...
- **Tier:** Community | **Price:** $1,500–$2,500
- **Status:** Warm lead via Cale, waiting on AA delivery

## Cale's 80 Referrals
- **Vertical:** Firearms/Tactical (mostly)
- **Tier:** Mix | **Est. Value:** $30,000–$60,000
- **Status:** Activates when AA ships and Cale shows his network
- **Dependency:** Need pricing structure ready before first call
